...
LIMITE_VELOCIDADE_INICIAL_ESTRELA = 0
LIMITE_VELOCIDADE_INICIAL_PLANETA = 50

MASSA_PLANETA = 5
LIMITE_INFERIOR_MASSA_ESTRELA = 10000
LIMITE_SUPERIOR_MASSA_ESTRELA = 15000
COR_ESTRELA=(150,70,8)

RAIO_PLANETA = 20 #raio do planeta
RAIO_PROPORCIONALIDADE = 2  # raio_estrela = (massa ** (1/3)) * RAIO_PROPORCIONALIDADE)

# Espaço virtual
ESCALA = 10  # Fator de escala: o mundo será 10x maior que a janela
